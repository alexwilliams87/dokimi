(function () {
  ...
  describe('Forms Admin Controller Tests', function () {
    // Initialize global variables
    var FormsAdminController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _FormsService_, _Notification_) {
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (FormsService) {
        ...
        expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Form saved successfully!' });
        // Test URL redirection after the form was created
        expect($state.go).toHaveBeenCalledWith('admin.forms.list');
      }));
      ...
      it('should call Notification.error if error', function () {
        ...
        expect(Notification.error).toHaveBeenCalledWith({ message: errorMessage, title: '<i class="glyphicon glyphicon-remove"></i> Form save error!' });
      });
    });
    ...
    describe('vm.save() as update', function () {
      ...
      it('should  call Notification.error if error', inject(function (FormsService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the form and redirect to forms', function () {
        ...
        expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Form deleted successfully!' });
        expect($state.go).toHaveBeenCalledWith('admin.forms.list');
      });
