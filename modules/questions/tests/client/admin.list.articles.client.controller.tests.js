(function () {
  ...
  describe('Admin Questions List Controller Tests', function () {
    // Initialize global variables
    var QuestionsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _QuestionsService_) {
      ...
      $httpBackend.whenGET('/modules/questions/client/views/list-questions.client.view.html').respond(200, '');
      ...
      QuestionsAdminListController = $controller('QuestionsAdminListController as vm', {
        $scope: $scope
      });
