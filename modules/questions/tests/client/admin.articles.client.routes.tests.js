    ...
    describe('Route Config', function () {
      describe('Main Route', function () {
        ...
        beforeEach(inject(function ($state) {
          mainstate = $state.get('admin.questions');
        }));
      ...
      describe('List Route', function () {
        var liststate;
        beforeEach(inject(function ($state) {
          liststate = $state.get('admin.questions.list');
        }));
        ...
        it('Should have templateUrl', function () {
          expect(liststate.templateUrl).toBe('/modules/questions/client/views/admin/list-questions.client.view.html');
        });
      });
      ...
      describe('Create Route', function () {
        ...
        it('should respond to URL', inject(function ($state) {
          expect($state.href(createstate)).toEqual('/admin/questions/create');
        }));
        ...
        it('Should have templateUrl', function () {
          expect(createstate.templateUrl).toBe('/modules/questions/client/views/admin/form-question.client.view.html');
        });
      });
      ...
      describe('Edit Route', function () {
        ...
        it('should respond to URL', inject(function ($state) {
          expect($state.href(editstate, {
            questionId: 1
          })).toEqual('/admin/questions/1/edit');
        }));
        ...
        it('Should have templateUrl', function () {
          expect(editstate.templateUrl).toBe('/modules/questions/client/views/admin/form-question.client.view.html');
        });
