/**
 * <dk-missing></dk-missing>
 * <dk-missing string="" results=""></dk-missing>
 *
...
(function () {
  ...
  function dkCreateMissing() {
    var directive = {
      ...
      link: link,
      templateUrl: '/modules/questions/client/directives/templates/dk-missing/dk-create-missing.client.directive.template.html',
    };
